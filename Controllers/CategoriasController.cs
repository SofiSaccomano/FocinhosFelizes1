...
namespace FocinhosFelizes1.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CategoriaId,TipoCategoria,DescricaoCategoria")] Categoria categoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("CategoriaId,TipoCategoria,DescricaoCategoria")] Categoria categoria)
        {
